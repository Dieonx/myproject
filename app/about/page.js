...
const AboutPage = () => {
  return (
    <div className='p-7 sp-y-4 space-x-5'>
    <p className='px-4 py-8'>Hi my Name is Ebube Nwani and i am a web developer. i am currently studing software development in Godfrey Okoye University 
      locate in Enugu. I am in my 200 Level, I love software because i was exposed to devices and technology at a young age which i seeme to always find very fun and intresting 
